...
- Preserve Claude-compatible Markdown frontmatter (`model` and `effort`). Keep the Codex model and `reasoning_effort` routing metadata in the `Codex routing:` line; the installer promotes it to top-level fields in generated Codex TOML.
