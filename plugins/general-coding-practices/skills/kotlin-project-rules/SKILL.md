...
description: Use for Kotlin or Android Kotlin work involving .kt files, coroutines, concurrency, tests, or bug fixes where Codex should choose coroutine-first designs over Java threads, blocking, locks, synchronized, wait/notify, or Executor-style concurrency.
---
