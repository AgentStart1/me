...
3. Run `generate-diff-report.sh` to create an HTML report with selectable Git and Difftastic views. Warn when `difft` is unavailable, but continue with Git diff.
