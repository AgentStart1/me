...
description: Collect reports and code diffs, then generate a static report site and expose it via ngrok.
model: sonnet
effort: medium
---
...
3. Run `generate-diff-report.sh` to create an HTML diff report from the current branch.
